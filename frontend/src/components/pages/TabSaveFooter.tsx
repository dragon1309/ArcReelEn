...
/**
 * Sticky save footer for configuration tabs.
 * - isDirty=false: inline layout, save button disabled
 * - isDirty=true: sticky at the bottom of the viewport, save button highlighted
 */
