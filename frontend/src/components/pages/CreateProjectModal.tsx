      ...
      if (styleImageFile) {
        try {
          ...
          useAppStore.getState().pushToast(
            "Style reference upload failed. You can upload it later in project settings.",
            "warning"
          );
        }
      }
      ...
      <div className="w-full max-w-md rounded-xl border border-gray-700 bg-gray-900 p-6 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
              ...
              placeholder="e.g. The Reborn Empress"
            ...
            <p className="mt-1 text-xs text-gray-600">
              ArcReel will generate an internal project ID for URLs and file storage.
            </p>
          </div>
            ...
            <p className="text-xs text-gray-600 mb-1.5">
              Let AI choose the duration automatically, or set a fixed default.
            </p>
            ...
            />
            <p className="mt-1 text-xs text-gray-600">
              ArcReel will analyze the uploaded image and reuse its visual style across generated assets.
            </p>
          </div>
