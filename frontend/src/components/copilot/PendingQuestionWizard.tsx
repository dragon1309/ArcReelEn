          ...
          >
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400">
                {currentQuestion.multiSelect ? "Multiple choice" : "Single choice"}
              </span>
            </div>

            <p className="mb-3 text-sm leading-6 text-slate-100">
              {currentQuestion.question || "Please choose an option"}
            </p>
            ...
            {isOtherSelected(currentQuestion, currentQuestionAnswer) && (
              <div className="mt-3">
                <input
                  ...
                  placeholder="Enter another response"
                  disabled={answeringQuestion}
        ...
        <div className="shrink-0 space-y-3">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {isLastQuestion ? (
              ...
              >
                {answeringQuestion ? "Submitting..." : "Finish and Submit"}
              </button>
            ) : (
              <button
                type="button"
