...
// ---------------------------------------------------------------------------
// SessionSelector -- session dropdown
// ---------------------------------------------------------------------------
            ...
            {sessions.map((session) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); if (confirm("Delete this session? This action cannot be undone.")) onDelete(session.id); }}
...
export function AgentCopilot() {
  ...
  const inputPlaceholder = pendingQuestion
    ...
    : isRunning
      ? "The assistant is generating. Click stop to interrupt."
      : "Type a message, or type / to browse available skills";
        ...
        {allTurns.length === 0 && !messagesLoading && (
          <div className="flex h-full flex-col items-center justify-center text-center text-gray-500">
            ...
            <p className="mt-1 text-xs text-gray-600">
              Type / for quick access to skills
            </p>
          </div>
        )}
        {allTurns.map((turn, i) => (
      ...
      <div className="border-t border-gray-800 p-3">
        ...
        >
          ...
          <button
            ...
            title={attachedImages.length >= MAX_IMAGES ? `Attach up to ${MAX_IMAGES} images` : "Attach images"}
