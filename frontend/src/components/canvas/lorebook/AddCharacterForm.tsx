      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Describe the character's appearance, personality, background, and more..."
            rows={3}
        ...
        <div>
          ...
          <input
            ...
            placeholder="Optional, for example: gentle but authoritative"
            className="w-full rounded-lg border border-gray-700 bg-gray-800 px-3 py-1.5 text-sm text-gray-200 placeholder-gray-500 outline-none focus:border-indigo-500"
          />
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-600">
            Used to keep the character consistent in future character sheet generation
          </p>
        </div>
