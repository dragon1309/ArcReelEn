...
// ---------------------------------------------------------------------------
// UsageDrawer - cost details drawer
// ---------------------------------------------------------------------------
    ...
    >
      ...
      <div className="max-h-72 overflow-y-auto">
        {callsLoading ? (
          ...
          <div className="flex items-center justify-center py-8 text-xs text-gray-500">No calls yet</div>
        ) : (
...
function extractFilename(outputPath: string | null | undefined): string {
  ...
  // e.g. "characters/jiang-yuehui.png" -> "jiang-yuehui.png"
