...
class GrokVideoBackend:
    ...
    async def generate(self, request: VideoGenerationRequest) -> VideoGenerationResult:
        ...
        logger.info("Starting Grok video generation: model=%s, duration=%ds", self._model, request.duration_seconds)
        ...
        logger.info("Downloaded Grok video to %s", request.output_path)
