"""Cost estimation service for projected and actual usage totals."""
...
class CostEstimationService:
    ...
    async def compute(
        ...
        *,
        ...
        # Resolve the current model configuration within a shared session.
        ...
        # Apply project-level image overrides.
        ...
        # Precompute the image unit cost; it is the same for every segment.
        ...
        try:
            ...
            logger.debug("Unable to calculate the estimated image unit cost", exc_info=True)
        ...
        for ep_meta in episodes_meta:
            ...
            for seg in raw_segments:
                ...
                try:
                    ...
                    logger.debug("Unable to calculate the estimated video cost for %s", seg_id, exc_info=True)
